 ...
 */
	public function add() {
		...
		$classnotes = $this->Frequency->Classnote->find('list');
		$disciplineStudents = $this->Frequency->DisciplineStudent->find('list');
		$this->set(compact('classnotes', 'disciplineStudents'));
	}
