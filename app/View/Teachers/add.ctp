<h2><?php echo __('Adicionar Professor'); ?></h2>
    ...
    <div class="col-lg-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                ...
                <div class="col-lg-4">    
                    <div class="form-group">
                        <?php echo $this->Form->input('titulacao', array('label' => 'Titulação', 'class' => 'form-control','options' => array('Linceciatura','Bacharel','Pós-Graduação','Mestrado', 'Doutorado'))); ?>
                    </div>
                </div>
